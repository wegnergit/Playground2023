...
public class ArmSimulation extends SubsystemBase {
    private static final int kMotorPort = 10;
    private static final int kEncoderAChannel = 20;
    private static final int kEncoderBChannel = 21;
    ...
    public void controlArm(boolean isButtonPressed) {
      if (isButtonPressed) {
